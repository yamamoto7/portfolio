...
export const metadata: Metadata = { title: "Privacy Policy - Buylis" };

export default function Page() {
  return (
    <>
      <BuylisHeader />
      <div className={TERMS_WRAPPER_CLASS}>
        <h2>Privacy Policy</h2>
        <h4>About</h4>
        <p>
          ychof built the `Buy List app` as a Free app. This SERVICE is provided
          by ychof at no cost and is intended for use as is.
        </p>
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at Buy List unless
