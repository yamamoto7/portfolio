                ...
                <div className="container">
                  ...
                  films he watched during his first decades
                    ...
                    <div className="row justify-content-center align-items-center content-l7-2-items">
                        ...
                        >
                            <div className="
                            content-l7-2-content-1 d-sm-flex d-lg-block justify-content-sm-between justify-content-lg-start">
                      ...
                      noticed by me: when I hear the buzz of the
                        ...
                        >
                            <div className="
                            content-l7-2-content-2 d-sm-flex d-lg-block justify-content-sm-between justify-content-lg-start">
